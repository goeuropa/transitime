...
public class Block implements Serializable {
    ...
    /**
     * Like toString() but only outputs core info. Doesn't output the trips except to identify them.
     * This is a big difference from toString() because each Trip has lots of info to output.
     *
     * @return
     */
    public String toShortString() {
        ...
        return "Block ["
                ...
                + Time.timeOfDayStr(endTime)
                + ", trips="
                + tripsStr // Use the shortened version
                + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (routeIds == null) {
            if (other.routeIds != null) return false;
        } else if (!routeIds.equals(other.routeIds)) return false;
        if (serviceId == null) {
